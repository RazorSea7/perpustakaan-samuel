    ...
    foreach ($query as $row) 
    {
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="form-group mt-2">
                    <input value="<?php echo $row['tempat_lahir']?>" class="form-control" type="text" name="tpt_lahir" placeholder="tpt Lahir">
                </div>
                <div class="form-group mt-2">
                ...
                <div class="form-group mt-2">
                    <textarea name="alamat" class="form-control" placeholder="Alamat Lengkap"><?php echo $row['alamat']?></textarea>
                        ...
                        <div class="form-group mt-2">
                            <center>
                                <button name="edit" class="btn btn-primary mb-3" type="submit">
                                    Save Edit
                                </button>
                            </center>
                        </div>
